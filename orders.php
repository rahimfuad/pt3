      ...
      <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
        ...
        <form action="orders.php" method="post" class="form-horizontal">
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input name="oid" type="text" readonly placeholder="Order ID" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_order_num']; ?>"required="">
            </div>
          </div>
          <div class="form-group">
            <label for="orderdate" class="col-sm-3 control-label">Date</label>
            <div class="col-sm-9">
              <input name="orderdate" type="text" readonly value="<?php if(isset($_GET['edit'])) echo $editrow['fld_order_date']; ?>"required="">
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-9">
              ...
              try {
                ...
                $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                  $stmt = $conn->prepare("SELECT * FROM tbl_staffs_a150854");
                $stmt->execute();
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              ...
              try {
                $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
                $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                  $stmt = $conn->prepare("SELECT * FROM tbl_customers_a150854");
                $stmt->execute();
                $result = $stmt->fetchAll();
              }
              catch(PDOException $e){
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      ...
      <table class="table table-striped table-bordered">
        ...
        try {
          $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
          $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
          $sql = "SELECT * FROM tbl_orders_a150854, tbl_staffs_a150854, tbl_customers_a150854 WHERE ";
          $sql = $sql."tbl_orders_a150854.fld_staff_num = tbl_staffs_a150854.fld_staff_num and ";
          $sql = $sql."tbl_orders_a150854.fld_customer_num = tbl_customers_a150854.fld_customer_num";
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      <nav>
          ...
          try {
            $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
            $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
            $stmt = $conn->prepare("SELECT * FROM tbl_orders_a150854");
            $stmt->execute();
            $result = $stmt->fetchAll();
