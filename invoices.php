...
<?php
    try {
      ...
      $stmt = $conn->prepare("SELECT * FROM tbl_orders_a150854, tbl_staffs_a150854,
        tbl_customers_a150854, tbl_orders_details_a150854 WHERE
        ...
        tbl_orders_a150854.fld_order_num = tbl_orders_details_a150854.fld_order_num AND
        tbl_orders_a150854.fld_order_num = :oid");
...
<meta charset="utf-8">
  ...
  <title>Necklace Shop Ordering System : Invoice</title>
   <!-- Bootstrap -->
...
<div class="col-xs-6 text-right">
  <h1>INVOICE</h1>
  <h4>Order ID: <?php echo $readrow['fld_order_num'] ?></h4>
  <h4>Order Date: <?php echo $readrow['fld_order_date'] ?></h4>
</div>
</div>
<hr>
<div class="row">
  <div class="col-xs-5">
    ...
    <p>
    Lot 3A Taman Melur Cempaka <br>
    83300 Batu Pahat2 <br>
    Johor<br>
    <br>
    </p>
    </div>
        ...
        <div class="col-xs-5 col-xs-offset-2 text-right">
          <div class="panel panel-default">
            <div class="panel-heading">
              <h4>Staff: <?php echo $readrow['fld_staff_fname']; ?></h4>
              <h4>Customer NAME: <?php echo $readrow['fld_customer_fname']; ?></h4>
